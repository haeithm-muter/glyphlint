...
**10 targets attempted** out of 30 on the list · **7 answered** · **5 served a page in the writing system they were listed for**.
...
| Failed (timeout or error) | 2 |

2 of the 7 sites that answered did not serve their homepage to a scanner that identifies itself honestly. They are counted as scanned and excluded from the measured figure above: https://www.isna.ir, https://www.irna.ir.

### The two layers, side by side

| | Rules that reported | Elements reported | Sites with findings |
|---|---|---|---|
| Standard rules (axe-core) | 17 | 588 | 7 |
| Script-aware rules (GlyphLint) | 11 | 1635 | 5 |
...
Percentages are out of the 7 sites that were scanned — not out of the 10 attempted, and not out of the web.

| Rule | Sites | Of the sites scanned | Elements | Severity | Confidence |
|---|---|---|---|---|---|
| `physical-css-in-bidi-context` | 5 | 71.4% | 647 | moderate | medium |
| `insufficient-line-height-for-script` | 5 | 71.4% | 380 | moderate | heuristic |
| `clipped-stacked-marks` | 4 | 57.1% | 81 | moderate | heuristic |
| `unisolated-bidi-run` | 4 | 57.1% | 29 | moderate | heuristic |
| `case-transform-on-caseless-script` | 3 | 42.9% | 53 | minor | high |
| `missing-dir-attribute` | 2 | 28.6% | 249 | serious | medium |
| `lang-script-mismatch` | 2 | 28.6% | 166 | serious | medium |
| `unmirrored-directional-icon` | 2 | 28.6% | 9 | minor | heuristic |
| `unsafe-word-break-for-script` | 1 | 14.3% | 18 | moderate | medium |
| `missing-script-font-coverage` | 1 | 14.3% | 2 | serious | heuristic |
| `cursive-script-letter-spacing` | 1 | 14.3% | 1 | critical | high |

axe-core reported 588 elements across 17 of its own rules on the same pages, and passed 230 checks. Those findings are axe's work, not ours.
